...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'WangGZ', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '想出发旅行，热爱生活。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wanggznotion.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，图库，旅行', // 网站关键词 英文逗号隔开
